...
A set is said to be \textbf{open} if around every point, we can fit a small open ball fully inside the set. And a set is \textbf{closed} if it contains its boundary points. This distinction will become more apparentl when we start talking about differentation. 
