...
Geometrically speaking, each constraint takes off part of space, and the feasible region is what's left after applying all the constraints when optimising our objective function 
